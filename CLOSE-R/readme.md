...
##### Arguments
  * CNstatus：`<sampleName>`.CNstatus.txt generated by CLOSER main function  (See [example.CNstatus.txt](https://github.com/xfwang/CLOSE/blob/master/CLOSE-R/example.CNstatus.txt))
...
#####Arguments
  * CNstatus：`<sampleName>`.CNstatus.txt generated by CLOSER main function 
